 ...
 * 
 * @see OfficeImportPluginApi
 */
public class OfficeImportPlugin extends XWikiDefaultPlugin
{
    /**
     * {@inheritDoc}
     *
     ...
     */
    public OfficeImportPlugin(String name, String className, XWikiContext context)
    {
