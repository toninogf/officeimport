...
public class TagBalancingTest extends TestCase {
    ...
    public void testBalancing() throws XPatherException, IOException {
        ...
        assertHtml(new File("src/test/resources/org/htmlcleaner/files/test3.html"), "/head/noscript/meta/@http-equiv", "Refresh");
        assertHtml(new File("src/test/resources/org/htmlcleaner/files/test3.html"), "count(/head/*)", "24");
        assertHtml(new File("src/test/resources/org/htmlcleaner/files/test3.html"), "/head/meta[1]/@name", "verify-v1");
        assertHtml(new File("src/test/resources/org/htmlcleaner/files/test3.html"), "/head/script[last()]/@language", "javascript1.1");
        assertHtml(new File("src/test/resources/org/htmlcleaner/files/test7.html"), "/head/noscript/meta/@http-equiv", "refresh");
    }
    ...
    public void testTagProviders() throws XPatherException, IOException {
        ...
        String s1 = serializer.getXmlAsString(cleaner1.clean(new File("src/test/resources/org/htmlcleaner/files/test5.html")));
        String s2 = serializer.getXmlAsString(cleaner2.clean(new File("src/test/resources/org/htmlcleaner/files/test5.html")));
        assertEquals(s1, s2);

        s1 = serializer.getXmlAsString(cleaner1.clean(new File("src/test/resources/org/htmlcleaner/files/test1.html")));
        s2 = serializer.getXmlAsString(cleaner2.clean(new File("src/test/resources/org/htmlcleaner/files/test1.html")));
        assertEquals(s1, s2);

        s1 = serializer.getXmlAsString(cleaner1.clean(new File("src/test/resources/org/htmlcleaner/files/test2.html")));
        s2 = serializer.getXmlAsString(cleaner2.clean(new File("src/test/resources/org/htmlcleaner/files/test2.html")));
        assertEquals(s1, s2);

        s1 = serializer.getXmlAsString(cleaner1.clean(new File("src/test/resources/org/htmlcleaner/files/test3.html")));
        s2 = serializer.getXmlAsString(cleaner2.clean(new File("src/test/resources/org/htmlcleaner/files/test3.html")));
        assertEquals(s1, s2);
    }
