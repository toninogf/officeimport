...
public class DomSerializer {
    ...
    public DomSerializer(HtmlCleaner htmlCleaner, boolean escapeXml) {
        ...
        if (tagChildren != null) {
            ...
            while (it.hasNext()) {
                ...
                if (item instanceof CommentToken) {
                    ...
                    boolean specialCase = htmlCleaner.isUseCdataForScriptAndStyle() &&
                                          ("script".equalsIgnoreCase(nodeName) || "style".equalsIgnoreCase(nodeName));
                    if (escapeXml && !specialCase) {
                        content = Utils.escapeXml( content,
                    ...
                    while (entryIterator.hasNext()) {
                        ...
                        if (escapeXml) {
                            attrValue = Utils.escapeXml( attrValue,
                                                         htmlCleaner.isAdvancedXmlEscape(),
                                                         htmlCleaner.isRecognizeUnicodeChars(),
                                                         htmlCleaner.isTranslateSpecialEntities() );
                        }
